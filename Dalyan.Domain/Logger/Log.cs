...
namespace Dalyan.Domain.Logger
{
  public class Log : ILog
  {
    ...
    private void WriteLogToFile(LogType logtype, LogLevel loglevel, Exception ex, String message, Exception exlog)
    {
      ...
      string combinedPath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, relativePath);
      string filename = combinedPath + DateTime.Now.Ticks.ToString() + ".txt";
